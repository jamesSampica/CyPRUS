        ...
        void *dummy2 ATTRIBUTE_UNUSED, struct tm *currenttime_tm)
{
    ...
    if (cnt->new_img & NEWIMG_ON) {
        ...
        put_picture(cnt, fullfilename, newimg, FTYPE_IMAGE, 1);
    }
}
            ...
            void *dummy2 ATTRIBUTE_UNUSED, struct tm *currenttime_tm)
{
    ...
    if (conf->motion_img) {
        ...
        put_picture(cnt, fullfilenamem, cnt->imgs.out, FTYPE_IMAGE_MOTION, 1);
    }
}
            ...
            void *dummy2 ATTRIBUTE_UNUSED, struct tm *currenttime_tm)
{
    ...
    if (strcmp(cnt->conf.snappath, "lastsnap")) {
        ...
        put_picture(cnt, fullfilename, img, FTYPE_IMAGE_SNAPSHOT, 1);
