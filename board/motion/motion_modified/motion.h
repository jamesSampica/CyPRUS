...
struct images {
    ...
    struct image_data preview_image2;  /* Picture buffer for best image when enables */
    struct image_data preview_image3;  /* Picture buffer for best image when enables */
